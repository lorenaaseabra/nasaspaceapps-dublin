...
function App() {
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: '3rem', marginBottom: '1rem' }}>🚀 AstroDefenders</h1>
      <p style={{ fontSize: '1.2rem', marginBottom: '2rem' }}>NASA Educational Space Game</p>
      ...
      <div style={{
        ...
        <p>✅ Server Status: Running on http://localhost:3000</p>
